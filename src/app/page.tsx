...
export default async function HomePage() {
  const posts = (await getPublishedPosts()).slice(0, 6);
  return <>
    ...
    <section className="section container split"><div><span className="eyebrow">03 / Experience</span><h2>Enterprise experience, practical engineering.</h2></div><div className="experience-summary"><article><b>STMicroelectronics</b><span>Application Software Engineer</span><p>Java, enterprise systems, SQL-heavy workflows, integrations and performance optimization.</p></article><article><b>Nagarro</b><span>Software Engineer</span><p>Backend APIs, automation and enterprise application delivery.</p></article></div></section>
